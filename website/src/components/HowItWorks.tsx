...
const STEPS: Step[] = [
  {
    ...
    body: 'Point Popush at your VPS with its SSH key. It verifies the host key on first connect — a changed key is refused, so no silent man-in-the-middle.',
  },
  {
    num: '02',
    title: 'Add a site',
  ...
  return (
    <section id="how">
      <div className="wrap">
        ...
        <div className="steps">
          {STEPS.map((s) => (
            <article className="stepcard" key={s.num}>
